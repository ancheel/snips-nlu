...
from api_bench.lib.intent_tools import create_entity, add_intent_heavy
...
class ApiaiHeavyNLUEngine(NLUEngine):
    ...
    def fit(self, dataset):
        ...
        for intent in self.intents:
            intent_dict[intent] = add_intent_heavy(intent, mapping_builtin,
